...
public sealed class PeakOrganizationConfiguration : IEntityTypeConfiguration<PeakOrganization>
{
    /// <summary>
    /// The database configuration for PeakOrganizations. 
    /// </summary>
    public void Configure(EntityTypeBuilder<PeakOrganization> builder)
    {
