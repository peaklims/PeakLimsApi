...
namespace PeakLims.Migrations
{
    ...
    [Migration("20250120004536_AddWorldBuildingTracking")]
    partial class AddWorldBuildingTracking
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PeakLims.Domain.AccessionComments.AccessionComment", b =>
                {
                    ...
                    b.Property<string>("CommentedByIdentifier")
                        .HasColumnType("text")
                        .HasColumnName("commented_by_identifier");
            ...
            modelBuilder.Entity("PeakLims.Domain.PanelTestAssignment", b =>
                {
                    b.Property<Guid>("PanelId")
                        .HasColumnType("uuid")
                        .HasColumnName("panel_id");
                    ...
                    b.HasKey("PanelId", "TestId")
                        .HasName("pk_panel_test_assignment");

                    b.HasIndex("TestId")
                        .HasDatabaseName("ix_panel_test_assignment_test_id");

                    b.ToTable("panel_test_assignment", (string)null);
                });
            ...
            modelBuilder.Entity("PeakLims.Domain.PatientRelationships.PatientRelationship", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid>("FromPatientId")
                        .HasColumnType("uuid")
                        .HasColumnName("from_patient_id");

                    b.Property<string>("FromRelationship")
                        .HasColumnType("text")
                        .HasColumnName("from_relationship");
                    ...
                    b.Property<Guid>("ToPatientId")
                        .HasColumnType("uuid")
                        .HasColumnName("to_patient_id");

                    b.Property<string>("ToRelationship")
                        .HasColumnType("text")
                        .HasColumnName("to_relationship");

                    b.HasKey("Id")
                        .HasName("pk_patient_relationships");

                    b.HasIndex("FromPatientId")
                        .HasDatabaseName("ix_patient_relationships_from_patient_id");

                    b.HasIndex("ToPatientId")
                        .HasDatabaseName("ix_patient_relationships_to_patient_id");

                    b.ToTable("patient_relationships", (string)null);
                });
            ...
            modelBuilder.Entity("PeakLims.Domain.PeakOrganizations.PeakOrganization", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_peak_organizations");

                    b.ToTable("peak_organizations", (string)null);
                });
            ...
            modelBuilder.Entity("PeakLims.Domain.Tests.Test", b =>
                {
                    ...
                    b.Property<int>("StatTurnAroundTime")
                        .HasColumnType("integer")
                        .HasColumnName("stat_turn_around_time");
            ...
            modelBuilder.Entity("PeakLims.Domain.PanelTestAssignment", b =>
                {
                    b.HasOne("PeakLims.Domain.Panels.Panel", "Panel")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_panel_test_assignment_panels_panel_id");

                    b.HasOne("PeakLims.Domain.Tests.Test", "Test")
                        .WithMany("PanelTestAssignments")
                        .HasForeignKey("TestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_panel_test_assignment_tests_test_id");
            ...
            modelBuilder.Entity("PeakLims.Domain.PatientRelationships.PatientRelationship", b =>
                {
                    b.HasOne("PeakLims.Domain.Patients.Patient", "FromPatient")
                        .WithMany("FromRelationships")
                        .HasForeignKey("FromPatientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_patient_relationships_patients_from_patient_id");

                    b.HasOne("PeakLims.Domain.Patients.Patient", "ToPatient")
                        .WithMany("ToRelationships")
                        .HasForeignKey("ToPatientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_patient_relationships_patients_to_patient_id");

                    b.Navigation("FromPatient");

                    b.Navigation("ToPatient");
                });
            ...
            modelBuilder.Entity("PeakLims.Domain.Tests.Test", b =>
                {
                    b.Navigation("PanelTestAssignments");
                });
